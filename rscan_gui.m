...
hBtnRun = uicontrol(hFig, 'Style', 'pushbutton', 'String', '▶  RUN PIPELINE', ...
                    'Units', 'pixels', 'Position', [35, 175, 175, 32], ...
...
hBtnCurate = uicontrol(hFig, 'Style', 'pushbutton', 'String', '🔍  Curate Trial', ...
                       'Units', 'pixels', 'Position', [220, 175, 150, 32], ...
                       'FontName', font_main, 'FontSize', 9, 'FontWeight', 'bold', ...
                       'BackgroundColor', c_curate, 'ForegroundColor', [1, 1, 1], ...
                       'Callback', @curate_callback);

hBtnBatchCurate = uicontrol(hFig, 'Style', 'pushbutton', 'String', '🖼️  Batch Curator App', ...
                            'Units', 'pixels', 'Position', [380, 175, 175, 32], ...
                            'FontName', font_main, 'FontSize', 9, 'FontWeight', 'bold', ...
                            'BackgroundColor', [0.35, 0.35, 0.65], 'ForegroundColor', [1, 1, 1], ...
                            'Callback', @batch_curator_callback);

hBtnOpenOut = uicontrol(hFig, 'Style', 'pushbutton', 'String', 'Open Output Folder', ...
                        'Units', 'pixels', 'Position', [565, 175, 175, 32], ...
...
% =========================================================================
    ...
    function batch_curator_callback(~, ~)
        out_dir = get(hEditOut, 'String');
        rscan_curator_app(out_dir);
    end
